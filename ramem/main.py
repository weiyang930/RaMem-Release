"""RaMem main system class integrating all pipeline components."""
...
class RaMemSystem:
    """RaMem contextual reinstatement memory QA system."""
    def __init__(
        self,
...
def create_system(
    ...
    """Create a RaMem system instance using config.py defaults when None."""
    return RaMemSystem(
        clear_db=clear_db,
        enable_planning=enable_planning,
        enable_reflection=enable_reflection,
...
if __name__ == "__main__":
    # Quick test with Qwen-compatible local serving.
    print("Running RaMem quick test...")
